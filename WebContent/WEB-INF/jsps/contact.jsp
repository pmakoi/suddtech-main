          ...
          <div class="col-md-6 col-md-offset-3">
            ...
            <input type="hidden" name="_eventId" value="send"/>
             ...
             <sft:errors path="name" cssClass="warning error"></sft:errors>
                <sft:input type="text" path="subject" style="width:450px;" class="form-control" name="subject" placeholder="Message subject "  value="${fromName } "/>
             ...
             <%--  <sft:textarea path="content" style="height: 300px; width: 500px;" class="form-control">
              </sft:textarea> --%>
