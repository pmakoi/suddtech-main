...
<div class="container _container" id="contactContainer">
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <h2>Contact<span class="glyphicon glyphicon-pencil" area-hidden="true"></span></h2>
            <?php echo $result;?>
            ...
            <input type="hidden" name="_eventId" value="send"/>
             ...
             <sft:errors path="name" cssClass="warning error"></sft:errors>
                <sft:input type="text" path="name" style="width:450px;" class="form-control" name="name" placeholder="Your name" value="${fromName }"/>
               ...
               <sft:errors path="email" cssClass="warning error"></sft:errors>
                <sft:input type="email" path="email" style="width:450px;" class="form-control" name="email" placeholder="Your email"  value="${fromEmail }"/>
                <span class="input-group-addon"  id="basic-addon">@</span> 
              </div>
              
              <div style="margin-bottom: 15px;" class="input-group input-group-lg">
              <sft:errors path="subject" cssClass="warning error"></sft:errors>
                <sft:input type="text" path="subject" style="width:450px;" class="form-control" name="subject" placeholder="Subject" />
                <span class="input-group-addon"  id="basic-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>   
              </div>
             
             <div class="form-group form-group-lg">
             <sft:errors path="content" cssClass="warning error"></sft:errors>
             <%--  <sft:textarea path="content" style="height: 300px; width: 500px;" class="form-control" placeholder="Your message  ...." >
              </sft:textarea> --%>
              <sft:textarea path="content" placeholder="Your message" class="form-control" style="height:300px; width:500px;"/>
             </div> 
             <div class="form-group form-group-lg col-md-offset-5">
